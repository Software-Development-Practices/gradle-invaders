...
public final class Core {
	...
	public static void main(final String[] args) {
		...
		do {
			...
			case 1:
				// Main menu.
				backGroundMusic = new Sound("music/mainBgm.wav");
			...
			case 2:
				// Game & score.
				backGroundMusic = new Sound("music/gameScreenBgm.wav");
				backGroundMusic.playSoundLoop(musicVolume);
				do {
			...
			case 3:
				// High scores.
				backGroundMusic = new Sound("music/scoreScreenBgm.wav");
				backGroundMusic.playSoundLoop(musicVolume);
			...
			case 4:
				...
				break;
			case 5:
				backGroundMusic = new Sound("music/settingScreenBgm.wav");
				backGroundMusic.playSoundLoop(musicVolume);
