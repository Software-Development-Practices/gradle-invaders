...
/**
 * Implements an object that stores a single game's difficulty settings. 단일 게임의
 * 난이도 설정을 저장하는 개체를 구현합니다.
 * 
...
public class GameSettings {
	...
	/**
	 * Width of the level's enemy formation. 레벨의 적 포메이션의 너비입니다.
	 */
	private int formationWidth;
	/**
	 * Height of the level's enemy formation. 레벨의 적 포메이션의 높이입니다.
	 */
	private int formationHeight;
	/**
	 * Speed of the enemies, function of the remaining number. 적들의 속도, 남은 숫자의 기능.
	 */
