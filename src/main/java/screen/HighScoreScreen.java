...
/**
 * Implements the high scores screen, it shows player records. 고득점 화면을 구현하여
 * 플레이어의 기록을 보여줍니다.
 * 
...
public class HighScoreScreen extends Screen {
	 ...
	 * @param fps    Frames per second, frame rate at which the game is run. 초당 프레임
	 *               수, 게임이 실행되는 프레임 속도입니다.
	 */
