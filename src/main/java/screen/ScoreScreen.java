...
/**
 * Implements the score screen. 점수 화면을 구현합니다.
 * 
...
public class ScoreScreen extends Screen {
	...
	/**
	 * Maximum number of high scores. 최고 점수의 최대 수입니다.
	 */
	private static final int MAX_HIGH_SCORE_NUM = 7;
	/**
	 * Code of first mayus character. 첫 번째 Mayus 문자의 코드입니다.
	 */
	private static final int FIRST_CHAR = 65;
	/**
	 * Code of last mayus character. 마지막 Mayus 문자의 코드입니다.
	 */
	...
	/**
	 * Total bullets shot by the player. 플레이어가 쏜 전체 총알입니다.
	 */
	...
	/**
	 * List of past high scores. 과거 최고 점수 List입니다.
	 */
	private List<Score> highScores;
	/**
	 * Checks if current score is a new high score. 현재 점수가 새로운 최고 점수인지 확인합니다.
	 */
	private boolean isNewRecord;
	/**
	 * Player name for record input. 레코드 입력을 위한 플레이어 이름입니다.
	 */
	private char[] name;
	/**
	 * Character of players name selected for change. 변경을 위해 선택된 플레이어 이름의 캐릭터.
	 */
	 ...
	 */
	public ScoreScreen(final int width, final int height, final int fps, final GameState gameState) {
	...
	/**
	 * Saves the score as a high score. 점수를 높은 점수로 저장합니다.
	 */
	...
	private void draw() {
		...
		drawManager.drawResults(this, this.score, this.livesRemaining, this.shipsDestroyed,
				(float) this.shipsDestroyed / this.bulletsShot, this.isNewRecord);
