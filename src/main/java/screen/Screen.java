...
/**
 * Implements a generic screen. 일반 화면을 구현합니다.
 * 
...
public class Screen {
	...
	/**
	 * Frames per second shown on the screen. 화면에 표시되는 초당 프레임 수입니다.
	 */
	protected int fps;
	/**
	 * Screen insets. 화면 삽입.
	...
	/**
	 * Time until the screen accepts user input. 화면이 사용자 입력을 수락할 때까지의 시간입니다.
	 */
	...
	/**
	 * Initializes basic screen properties. 기본 화면 속성을 초기화합니다.
	 */
	...
	/**
	 * Activates the screen. 화면을 활성화합니다.
	 * 
	...
	/**
	 * Getter for screen width. 화면 너비에 대한 Getter.
	 * 
	 * @return Screen width.
	 */
	...
	/**
	 * Getter for screen height. 화면 높이에 대한 Getter.
	 * 
