...
public class GameScreen extends Screen {
	...
	/**
	 * Milliseconds until the screen accepts user input. 화면이 사용자 입력을 수락할 때까지의
	 * 시간(밀리초)입니다.
	 */
	private static final int INPUT_DELAY = 6000;
	/**
	 * Bonus score for each life remaining at the end of the level. 레벨이 끝날 때 남은 각
	 * 목숨에 대한 보너스 점수.
	 */
	private static final int LIFE_SCORE = 100;
	/**
	 * Minimum time between bonus ship's appearances. 보너스 함선의 출현 사이의 최소 시간.
	 */
	private static final int BONUS_SHIP_INTERVAL = 20000;
	/**
	 * Maximum variance in the time between bonus ship's appearances. 보너스 함선의 출현 사이의
	 * 최대 variance.
	 */
	private static final int BONUS_SHIP_VARIANCE = 10000;
	/**
	 * Time until bonus ship explosion disappears. 보너스 함선 폭발이 사라질 때까지의 시간.
	 */
	private static final int BONUS_SHIP_EXPLOSION = 500;
	/**
	 * Time from finishing the level to screen change. 레벨 완료 후 화면 변경까지의 시간입니다.
	 */
	...
	/**
	 * Current difficulty level number. 현재 난이도 번호입니다.
	 */
	private int level;
	/**
	 * Formation of enemy ships. 적 함선의 포메이션.
	 */
	private EnemyShipFormation enemyShipFormation;
	/**
	 * Player's ship. 플레이어의 함선.
	 */
	private Ship ship;
	/**
	 * Bonus enemy ship that appears sometimes. 가끔 등장하는 보너스 적함.
	 */
	private EnemyShip enemyShipSpecial;
	/**
	 * Minimum time between bonus ship appearances. 보너스 함선 출현 사이의 최소 시간.
	 */
	...
	/**
	 * Set of all bullets fired by on screen ships. 화면에서 발사한 모든 총알에 대한 설정입니다.
	 */
	...
	private int score;
	/**
	 * Player lives left. 플레이어의 남은 목숨.
	 */
	private int lives;
	/**
	 * Total bullets shot by the player. 플레이어가 쏜 전체 총알들입니다.
	 */
	private int bulletsShot;
	/**
	 * Total ships destroyed by the player. 플레이어가 파괴한 총 선박입니다.
	 */
	private int shipsDestroyed;
	/**
	 * Moment the game starts. 게임이 시작되는 순간.
	 */
	private long gameStartTime;
	/**
	 * Checks if the level is finished. 레벨이 완료되었는지 확인합니다.
	 */
	private boolean levelFinished;
	/**
	 * Checks if a bonus life is received. 보너스 목숨을 받았는지 확인합니다.
	 */
	...
	/**
	 * Initializes basic screen properties, and adds necessary elements. 기본 화면 속성을
	 * 초기화하고 필요한 요소를 추가합니다.
	 */
	...
	/**
	 * Cleans bullets that go off screen. 화면 밖으로 나가는 총알을 정리합니다.
	 */
