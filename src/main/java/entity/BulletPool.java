...
/**
 * Implements a pool of recyclable bullets. 재활용 가능한 총알 풀을 구현합니다.
 * 
...
public final class BulletPool {
	...
	/**
	 * Set of already created bullets. 이미 생성된 총알들의 집합입니다.
	 */
	 ...
	 * 
	 * @param positionX Requested position of the bullet in the X axis. X축에서 총알의 요청된
	 *                  위치입니다.
	 * @param positionY Requested position of the bullet in the Y axis. Y축에서 총알의 요청된
	 *                  위치입니다.
	 * @param speed     Requested speed of the bullet, positive or negative
	 *                  depending on direction - positive is down. 총알의 요청된 속도, 방향에
	 *                  따라 양수 또는 음수 - 양수는 아래입니다.
	...
	/**
	 * Adds one or more bullets to the list of available ones. 사용 가능한 목록에 하나 이상의
	 * 총알들을 추가합니다.
	 * 
